...
def decompose_ac(db_smiles,radius=1):
    ...
    fname = './data/SMILES_moieties/decompose_vector_radius_' + str(radius) + '_cmd_run.json'
...
with open('./metanetx_metab_db_final.json') as mnx_met_final:
...
decompose_ac(metanetx_metab_db_smiles, radius = 2)