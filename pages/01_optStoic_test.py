...
def main():
    ...
    min_int_val = st.number_input("Set lower bound for stoichiometry values", value = -5.0)
    max_int_val = st.number_input("Set upper bound for stoichiometry values", value = 5.0)
